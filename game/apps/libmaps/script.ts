...
const LOCATIONS: MapLocation[] = [
	...
	{ id: 'l11', name: '新<br>刊<br>・<br>人<br>気<br>作<br>・<br>映<br>像<br>化<br>作<br>品', name_s: '新刊・人気作・映像化作品', description: '新規入荷作品、人気作品、映像化（アニメ・実写）された作品たちです。<br>"ｎ分後シリーズ"や"ソードアート・オンライン"、"薬屋のひとりごと"などはここです。', left: 2, top: 47 },
